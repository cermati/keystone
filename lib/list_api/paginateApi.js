					...
					_.forEach(searchQueryRegex,function(value,key){
						...
						if (key!='$or'){
							if (value instanceof RegExp) {
								var preparedValue = _.replace(value.source,/\\/g,'');
								preparedValue = encodeURIComponent(preparedValue);

								model._params[key] = preparedValue;
							}
							else {
								if (value instanceof Object) {
									...
									var preparedValue = _.replace(value,/\\/g,'');
									preparedValue = encodeURIComponent(preparedValue);
