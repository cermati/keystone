 ...
 */
function getSearchFilters (search, add, searchFlag) {
	var filters = {};
	var list = this;
	...
	if (search.length) {
		...
		searchFields.forEach(function (path) {
			...
			if (field && field.type === 'name') {
				var first = {};
				first[field.paths.first] = (searchFlag) ? splitSearchRx : search;
				var last = {};
				last[field.paths.last] = (searchFlag) ? splitSearchRx : search;
				searchFilter = {};
